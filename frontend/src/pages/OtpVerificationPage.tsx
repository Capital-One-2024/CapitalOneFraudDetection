...
const OTPInputWithZod = () => {
    ...
    const handleKeyUp = (e: React.KeyboardEvent<HTMLInputElement>, index: number) => {
        // If no value and backspace pressed, focus previous cell
        ...
        // If value, remove and focus previous cell
        if (e.key === 'Backspace' && e.currentTarget.value) {
    ...
    return (
        ...
        >
            ...
            <Grid2 sx={{ textAlign: 'center', mb: 12 }}>
                ...
                <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '16px' }}>
                    <Grid2 sx={{ my: 4 }}>
